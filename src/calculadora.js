...
function Calculadora() {
  ...
  const [calcular, concatenarNumero, 
    SOMA, SUBTRACAO, DIVISAO, MULTIPLICACAO] = CalculadoraService();
  ...
  function definirOperacao(op){
    // apenas define a operação caso ela não exista
      if(operacao === null || numero2 === null){
        setOperacao(op);
        return;
      }
    // caso operação estiver definida e número 2 selecionado, realiza o cálculo
      if(numero2 !== null){
